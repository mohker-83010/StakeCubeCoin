...
from test_framework.messages import SCChash
...
def scchash_helper(b):
    return encode(scchash(b)[::-1], 'hex_codec').decode('ascii')
...
class ZMQTest (BitcoinTestFramework):
    ...
    def _zmq_test(self):
        ...
        for x in range(num_blocks):
            ...
            assert_equal(genhashes[x], scchash_helper(block[:80]))
