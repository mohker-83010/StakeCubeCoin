...
StakeCubeCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as StakeCubeCoin Core, where everyone uses
...
pay attention to for reviewers of StakeCubeCoin Core code.

General StakeCubeCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: StakeCubeCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against StakeCubeCoin Core so that they can be integrated
...
- Wallet RPCs call BlockUntilSyncedToCurrentChain to maintain consistency with
  ...
  - *Rationale*: In previous versions of StakeCubeCoin Core, the wallet was always
