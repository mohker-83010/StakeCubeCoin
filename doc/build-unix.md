UNIX BUILD NOTES
====================
Some notes on how to build StakeCubeCoin Core in Unix.

(for OpenBSD specific instructions, see [build-openbsd.md](build-openbsd.md))

Base build dependencies
-----------------------
Building the dependencies and StakeCubeCoin Core requires some essential build tools and libraries to be installed before.
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, StakeCubeCoin Core may be compiled in
