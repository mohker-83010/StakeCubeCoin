...
Below are some notes on how to build StakeCubeCoin Core for Windows.

The options known to work for building StakeCubeCoin Core on Windows are:

* On Linux, using the [Mingw-w64](https://mingw-w64.org/doku.php) cross compiler tool chain. Ubuntu Bionic 18.04 is required
and is the platform used to build the StakeCubeCoin Core Windows release binaries.
