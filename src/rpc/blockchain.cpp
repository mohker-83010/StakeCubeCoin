...
static std::vector<RPCResult> MempoolEntryDescription() { return {
    ...
    RPCResult{RPCResult::Type::NUM, "size", "(DEPRECATED) same as vsize. Only returned if sccd is started with -deprecatedrpc=size. "
                ...
                {RPCResult::Type::OBJ, "scriptPubKey", "",
                    {
                        ...
                        {RPCResult::Type::ARR, "addresses", "array of SCC addresses",
                            {{RPCResult::Type::STR, "address", "SCC address"}}},
                    }},
