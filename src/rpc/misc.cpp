    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"getaddressbalance",
                ...
                RPCResult{
            "{\n"
            "  \"balance\": xxxxx,              (numeric) The current total balance in satoshis\n"
            "  \"balance_immature\": xxxxx,     (numeric) The current immature balance in satoshis\n"
            "  \"balance_spendable\": xxxxx,    (numeric) The current spendable balance in satoshis\n"
            "  \"received\": xxxxx              (numeric) The total number of satoshis received (including change)\n"
            "}\n"
                },
                RPCExamples{
